Fork of abandoned gem. Adapted to work with Active Job and Rails 4.2 and 5
...
Install the resque-status gem (which will pull in the dependencies).
  ...
  # Gemfile
  gem 'resque-status', github: 'KirillSuhodolov/resque-status', branch: 'master'
